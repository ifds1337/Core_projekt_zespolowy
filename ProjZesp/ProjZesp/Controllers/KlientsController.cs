...
namespace ProjZesp.Controllers
{
    public class KlientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Klient_Email,Klient_Imie,Klient_Nazwisko,Klient_NrTelefonu")] Klient klient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Klient_Email,Klient_Imie,Klient_Nazwisko,Klient_NrTelefonu")] Klient klient)
        {
            if (id != klient.ID)
            {
                return NotFound();
